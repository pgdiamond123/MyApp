...
import nnthien.com.myapp.Adapter.ListUsersAdapter;
    ...
    private void loadListUserInGroup() {
        ...
        QBRestChatService.getChatDialogById(qbChatDialog.getDialogId()).performAsync(new QBEntityCallback<QBChatDialog>() {
            ...
            public void onSuccess(QBChatDialog qbChatDialog, Bundle bundle) {
                ...
                List<QBUser> listUserAlreadyInChatGroup = QBUsersHolder.getInstance().getUsersByIds(occupantsIds);
    ...
    private void loadListAvailableUser() {
        ...
        QBRestChatService.getChatDialogById(qbChatDialog.getDialogId()).performAsync(new QBEntityCallback<QBChatDialog>() {
            ...
            public void onSuccess(QBChatDialog qbChatDialog, Bundle bundle) {
                ...
                List<QBUser> listUserAlreadyInChatGroups = QBUsersHolder.getInstance().getUsersByIds(occupantsId);

                //remove all user already in chat group

                for (QBUser user : listUserAlreadyInChatGroups){
        ...
        QBUsers.getUsers(null).performAsync(new QBEntityCallback<ArrayList<QBUser>>() {
            ...
            public void onSuccess(ArrayList<QBUser> qbUsers, Bundle bundle) {
                ...
                for (QBUser user : qbUsers){
                    if (!user.getLogin().equals(QBChatService.getInstance().toString())){
